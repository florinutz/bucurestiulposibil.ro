/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: c6f148445e221e43458decbfe50e3317)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_DISABLE_PROPOSALS: string;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SANITY_PROJECT_ID" | "NEXT_PUBLIC_SANITY_DATASET" | "SANITY_API_TOKEN" | "SANITY_WEBHOOK_SECRET" | "NEXT_PUBLIC_DISABLE_PROPOSALS">> {}
}
