/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: d0f724828fff6ecaea75663681a555da)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_DISABLE_PROPOSALS: true;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SANITY_PROJECT_ID" | "NEXT_PUBLIC_SANITY_DATASET" | "NEXT_PUBLIC_DISABLE_PROPOSALS">> {}
}
