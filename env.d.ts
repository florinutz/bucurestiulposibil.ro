/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: 9072b886354abe946e92e51872f6694b)
// Runtime types generated with workerd@1.20250709.0 2025-04-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_SANITY_PROJECT_ID: "dxicn1kk";
		NEXT_PUBLIC_SANITY_DATASET: "production";
		DB: D1Database;
		SANITY_API_TOKEN: SecretsStoreSecret;
		SANITY_WEBHOOK_SECRET: SecretsStoreSecret;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SANITY_PROJECT_ID" | "NEXT_PUBLIC_SANITY_DATASET">> {}
}
